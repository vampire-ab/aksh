...
const Invest = () => {
  return (
    <div className='top-[100px] relative h-[700px] flex justify-around rounded-tr-full rounded-bl-full bg-blue-300'>
      <div className='absolute w-[70vw] right-0 lg:right-20 lg:bottom-20 bottom-40 sm:bottom-10 md:bottom-0 md:right-10'>
      ...
      <div className="ml-20 md:ml-24 mt-40 font-semibold text-lg md:font-bold md:text-3xl w-[100vw] text-white z-10 align-middle">
        ...
        <Button className="lg:ml-0 sm:m-0 whitespace-normal flex-wrap left-8 lg:left-20 bg-gradient-to-r from-blue-900 to-blue-400 text-white mt-3 md:mt-9 md:ml-5">
          Get in Touch
        </Button>
      </div>
    </div>
