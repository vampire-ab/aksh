  ...
  return (
    <div className='top-[100px] relative h-[660px] flex justify-around rounded-tr-full rounded-bl-full bg-blue-300'>
      ...
      <div className="ml-20 md:ml-24 mt-40 w-[100vw]  z-10 align-middle">
        ...
        <Button className="hover:opacity-80 text-white lg:ml-0 sm:m-0 whitespace-normal flex-wrap left-8 lg:left-20 bg-gradient-to-r from-blue-500 to-blue-400 mt-3 md:mt-9 md:ml-5">
          Get in Touch
        </Button>
      </div>
    </div>
